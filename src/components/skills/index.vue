     ...
     <div class=" w-full max-w-3xl mx-auto pt-10 md:pt-16 px-4 sm:px-6 lg:px-8">
          ...
          <div class="space-y-3">
               <dl class="flex flex-col sm:flex-row gap-1">
                    <dt class="min-w-40">
                         <span class="block text-sm text-gray-500 ">Desenvolvimento:</span>
                    </dt>
                    <dd>
                         <ul>
                                   ...
                                   <svg width="14px" height="14px" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                             <path d="M14 11.25C14 10.2835 14.7835 9.5 15.75 9.5H17.25C17.6642 9.5 18 9.83579 18 10.25C18 10.6642 17.6642 11 17.25 11H15.75C15.6119 11 15.5 11.1119 15.5 11.25V12.75C15.5 12.8881 15.6119 13 15.75 13H16.25C17.2165 13 18 13.7835 18 14.75V16.25C18 17.2165 17.2165 18 16.25 18H14.75C14.3358 18 14 17.6642 14 17.25C14 16.8358 14.3358 16.5 14.75 16.5H16.25C16.3881 16.5 16.5 16.3881 16.5 16.25V14.75C16.5 14.6119 16.3881 14.5 16.25 14.5H15.75C14.7835 14.5 14 13.7165 14 12.75V11.25Z"
                                                  fill="#000"></path>
                                             <path d="M12.75 10.25C12.75 9.83579 12.4142 9.5 12 9.5C11.5858 9.5 11.25 9.83579 11.25 10.25V16.25C11.25 16.3881 11.1381 16.5 11 16.5H9.75C9.33579 16.5 9 16.8358 9 17.25C9 17.6642 9.33579 18 9.75 18H11C11.9665 18 12.75 17.2165 12.75 16.25V10.25Z"
                                                  fill="#000"></path>
                                             <path d="M3 6.25C3 4.45507 4.45507 3 6.25 3H17.75C19.5449 3 21 4.45507 21 6.25V17.75C21 19.5449 19.5449 21 17.75 21H6.25C4.45507 21 3 19.5449 3 17.75V6.25ZM6.25 4.5C5.2835 4.5 4.5 5.2835 4.5 6.25V17.75C4.5 18.7165 5.2835 19.5 6.25 19.5H17.75C18.7165 19.5 19.5 18.7165 19.5 17.75V6.25C19.5 5.2835 18.7165 4.5 17.75 4.5H6.25Z"
                                                  fill="#000"></path>
                                        </g>
                                   </svg>
                                   JavaScript
                              ...
                              <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 ">
                                   <svg fill="#000" width="14px" height="14px" viewBox="0 0 32 32"
               ...
               <dl class="flex flex-col sm:flex-row gap-1">
                    <dt class="min-w-40">
                         <span class="block text-sm text-gray-500 ">Design:</span>
                    </dt>
                    <dd>
                         <ul>
                              <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 ">
                              ...
                              <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 ">
                                   <svg fill="#000" width="24px" height="14px" viewBox="0 0 24 24" role="img"
                                        xmlns="http://www.w3.org/2000/svg" stroke="#000">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                        </g>
               ...
               <dl class="flex flex-col sm:flex-row gap-1">
                    <dt class="min-w-40">
                         <span class="block text-sm text-gray-500 ">Colaboração:</span>
                    </dt>
                    <dd>
                         <ul>
                              <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 ">
                              ...
                              <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 ">
                                   <svg width="14px" height="14px" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                             <path d="M6.77857 6.13902C7.7289 4.78181 9.59953 4.45197 10.9568 5.4023C12.314 6.35263 12.6438 8.22327 11.6935 9.58048L5.95771 17.772C5.00738 19.1292 3.13674 19.4591 1.77953 18.5087C0.422312 17.5584 0.0924684 15.6878 1.0428 14.3305L6.77857 6.13902Z"
                                                  fill="#000"></path>
                                             <path d="M15.2678 6.22799C16.2182 4.87077 18.0888 4.54093 19.446 5.49126C20.8032 6.44159 21.1331 8.31223 20.1827 9.66945L14.447 17.861C13.4966 19.2182 11.626 19.548 10.2688 18.5977C8.91158 17.6474 8.58173 15.7767 9.53207 14.4195L15.2678 6.22799Z"
                                                  fill="#000"></path>
                                             <path d="M20.5 18.8595C22.1569 18.8595 23.5 17.5164 23.5 15.8595C23.5 14.2026 22.1569 12.8595 20.5 12.8595C18.8431 12.8595 17.5 14.2026 17.5 15.8595C17.5 17.5164 18.8431 18.8595 20.5 18.8595Z"
                                                  fill="#000"></path>
                                        </g>
                                   </svg>
                                   Monday
               ...
               <dl class="flex flex-col sm:flex-row gap-1">
                    <dt class="min-w-40">
                         <span class="block text-sm text-gray-500 ">Experiência em design:</span>
                    </dt>
                    <dd>
                         <ul>
                              <li class="me-1 after:content-[','] inline-flex items-center text-sm text-gray-800 ">
               ...
               <dl class="flex flex-col sm:flex-row gap-1">
                    <dt class="min-w-40">
                         <span class="block text-sm text-gray-500 ">Soft
                              Skills:</span>
                    </dt>
                    <dd>
                         <ul>
