          ...
          <div class="mt-8">
               ...
               <ul class="mt-5 flex flex-col gap-y-3">
                    <li class="flex items-center gap-x-2.5">
                         ...
                         <a class="text-[13px] text-gray-600 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2  "
                              href="mailto:vagnerzezo@live.com">
                              vagnerzezo@live.com
                         </a>
                    </li>
                    <li class="flex items-center gap-x-2.5">
                         ...
                         <a class="text-[13px] text-gray-600 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2  "
                              href="https://www.linkedin.com/in/vagner-xavier/">
                              vagner-xavier
                         </a>
                    </li>
                    ...
                    <li class="flex items-center gap-x-2.5">
                         ...
                         <a class="text-[13px] text-gray-600 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2  "
                              href="https://www.instagram.com/vagnerxz/">
                              @vagnerxz
                         </a>
                    </li>
                    <li class="flex items-center gap-x-2.5">
                         <svg fill="#000000" width="16px" height="16px" viewBox="0 0 30 30"
                              xmlns="http://www.w3.org/2000/svg">
                              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                              <g id="SVGRepo_iconCarrier">
                         ...
                         <a class="text-[13px] text-gray-600 underline hover:text-gray-800 hover:decoration-2 focus:outline-none focus:decoration-2  "
                              href="https://github.com/vagnerzezo">
                              vagnerzezo
                         </a>
                    </li>
               </ul>
